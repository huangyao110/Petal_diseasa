...
from segmentation_models_pytorch.decoders.fpn.model import FPNDecoder # which is original FPN architecture from smg
from .fpndecoder import FPNDecoder as FPNDecoder_SCAML
