...
def invoke_main(img_dir="/home/hy/hy_dirver/2025/data/obj_dectetion/data_path_for_obj_dect/",
                cfg_file="./configs/Base-TridentNet-Fast-C4.yaml", 
                task_label='petal') -> None:
    if task_label == 'petal':
        register_qk_dataset(img_dir, label=task_label)
