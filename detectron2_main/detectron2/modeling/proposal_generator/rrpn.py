...
from detectron2_main.layers import ShapeSpec, batched_nms_rotated, cat
from detectron2_main.structures import Instances, RotatedBoxes, pairwise_iou_rotated
