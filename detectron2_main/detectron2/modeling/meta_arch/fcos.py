...
from detectron2_main.layers import ShapeSpec, batched_nms
from detectron2_main.structures import Boxes, ImageList, Instances, pairwise_point_box_distance
from detectron2_main.utils.events import get_event_storage

from ..anchor_generator import DefaultAnchorGenerator
from ..det import Backbone
