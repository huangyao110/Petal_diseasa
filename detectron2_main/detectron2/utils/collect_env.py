...
def collect_env_info():
    ...
    try:
        import detectron2_main  # noqa

        data.append(
            (
                "detectron2",
                detectron2_main.__version__ + " @" + os.path.dirname(detectron2_main.__file__),
            )
        )
    except ImportError:
    ...
    try:
        import detectron2_main._C as _C
...
def main() -> None:
    global x
    try:
        from detectron2_main.utils.collect_env import collect_env_info as f
