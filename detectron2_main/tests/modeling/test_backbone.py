...
import detectron2_main.export.torchscript  # apply patch # noqa
...
from detectron2_main.modeling.backbone import build_resnet_backbone
from detectron2_main.modeling.backbone.fpn import build_resnet_fpn_backbone
