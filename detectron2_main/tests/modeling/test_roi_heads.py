...
from detectron2_main.export.torchscript_patch import (
    freeze_training_mode,
    patch_builtin_len,
    patch_instances,
)
from detectron2_main.layers import ShapeSpec
from detectron2_main.modeling.proposal_generator.build import build_proposal_generator
...
from detectron2_main.projects import point_rend
from detectron2_main.structures import BitMasks, Boxes, ImageList, Instances, RotatedBoxes
from detectron2_main.utils.events import EventStorage
from detectron2_main.utils.testing import assert_instances_allclose, random_boxes
