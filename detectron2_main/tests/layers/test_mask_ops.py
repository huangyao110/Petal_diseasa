...
from detectron2_main.layers.mask_ops import (
    pad_masks,
    paste_mask_in_image_old,
    paste_masks_in_image,
    scale_boxes,
)
from detectron2_main.structures import BitMasks, Boxes, BoxMode, PolygonMasks
from detectron2_main.structures.masks import polygons_to_bitmask
from detectron2_main.utils.file_io import PathManager
from detectron2_main.utils.testing import random_boxes
