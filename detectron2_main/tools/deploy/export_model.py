...
import detectron2_main.data.transforms as T
from detectron2_main.checkpoint import DetectionCheckpointer
from detectron2_main.config import get_cfg
from detectron2_main.data import build_detection_test_loader, detection_utils
from detectron2_main.evaluation import COCOEvaluator, inference_on_dataset, print_csv_format
from detectron2_main.export import (
    STABLE_ONNX_OPSET_VERSION,
    TracingAdapter,
    dump_torchscript_IR,
    scripting_with_instances,
)
from detectron2_main.modeling import GeneralizedRCNN, RetinaNet, build_model
from detectron2_main.modeling.postprocessing import detector_postprocess
from detectron2_main.projects.point_rend import add_pointrend_config
from detectron2_main.structures import Boxes
from detectron2_main.utils.env import TORCH_VERSION
from detectron2_main.utils.file_io import PathManager
from detectron2_main.utils.logger import setup_logger
...
def export_caffe2_tracing(cfg, torch_model, inputs):
    from detectron2_main.export import Caffe2Tracer
