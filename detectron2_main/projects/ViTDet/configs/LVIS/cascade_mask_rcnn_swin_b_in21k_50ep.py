from detectron2_main.config.lazy import LazyCall as L
from detectron2_main.data.detection_utils import get_fed_loss_cls_weights
from detectron2_main.data.samplers import RepeatFactorTrainingSampler
from detectron2_main.evaluation.lvis_evaluation import LVISEvaluator
