...
from detectron2_main.layers import Conv2d, ShapeSpec, cat, interpolate
from detectron2_main.modeling import ROI_MASK_HEAD_REGISTRY
from detectron2_main.modeling.roi_heads.mask_head import mask_rcnn_inference, mask_rcnn_loss
